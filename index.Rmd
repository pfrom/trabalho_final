...
## Pobreza e Pobreza Extrema a partir da Linha Administrativa do Programa Bolsa Fam?lia
...
O teto da pobreza seria determinado pelo dobro disso, ou seja, 170 reais. Segundo esse padrão, para fins de gestão pública, todas as famílias com renda per capita que n?o atingem 85 reais recebem a complementação de renda que atinja esse valor. 

As famílias que estão com renda per capita domicliar entre 85 e 170 reais podem se benericiar do Programa caso se insiram em algumas condiçõees.
...
Existem ao todo 7 faixas de renda medidas na PNAD Contínua com base no salário mínimo: at? 1/4, de 1/4 a 1/2, de 1/2 a 1, de 1 a 2, de 2 a 3, de 3 a 5 e acima de 5 salários mínimos.
